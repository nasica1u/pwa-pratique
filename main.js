...
function loadTechnologies(technos) {
    ...
    fetch('https://us-central1-pwa-technos-2d668.cloudfunctions.net/getTechnos')
        .then(response => {
            response.json()
                .then(technos => {
...
if(navigator.serviceWorker) {
    ...
    navigator.serviceWorker
        ...
        .then(registration =>{
            ...
            const publicKey = "BJ35ot9FrTdchdbBAO2qpgWDHPooW5RWTHhgKcqzTIYj7l3SC7cxpklMeePXW6HemJQPyuwMC9lLQ8mr42CDUCE";
